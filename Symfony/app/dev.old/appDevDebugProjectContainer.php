...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_4140ad8b50baf4f1216902bd17258777');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_4140ad8b50baf4f1216902bd17258777');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_4140ad8b50baf4f1216902bd17258777');

        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => __DIR__.'/../../../src/Hotel/UserBundle/Entity', 1 => __DIR__.'/../../../src/Hotel/RoomBundle/Entity', 2 => __DIR__.'/../../../src/Hotel/BillBundle/Entity', 3 => __DIR__.'/../../../src/Hotel/MainBundle/Entity'));

        $f = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $f->addDriver($e, 'Hotel\\UserBundle\\Entity');
        $f->addDriver($e, 'Hotel\\RoomBundle\\Entity');
        $f->addDriver($e, 'Hotel\\BillBundle\\Entity');
        $f->addDriver($e, 'Hotel\\MainBundle\\Entity');

        $g = new \Doctrine\ORM\Configuration();
        $g->setEntityNamespaces(array('HotelUserBundle' => 'Hotel\\UserBundle\\Entity', 'HotelRoomBundle' => 'Hotel\\RoomBundle\\Entity', 'HotelBillBundle' => 'Hotel\\BillBundle\\Entity', 'HotelMainBundle' => 'Hotel\\MainBundle\\Entity'));
        ...
        $g->addCustomDatetimeFunction('datediff', 'Hotel\\BillBundle\\DQL\\DateDiff');
        $g->addCustomDatetimeFunction('timediff', 'Hotel\\BillBundle\\DQL\\TimeDiff');
        $g->addCustomDatetimeFunction('hour', 'Hotel\\BillBundle\\DQL\\Hour');
        $g->addCustomDatetimeFunction('minute', 'Hotel\\BillBundle\\DQL\\Minute');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(__DIR__.'/../../../src/Hotel/UserBundle/Resources/views', 'HotelUser');
        $instance->addPath(__DIR__.'/../../../src/Hotel/RoomBundle/Resources/views', 'HotelRoom');
        $instance->addPath(__DIR__.'/../../../src/Hotel/BillBundle/Resources/views', 'HotelBill');
        $instance->addPath(__DIR__.'/../../../src/Hotel/MainBundle/Resources/views', 'HotelMain');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'HotelUserBundle' => 'Hotel\\UserBundle\\HotelUserBundle',
                'HotelRoomBundle' => 'Hotel\\RoomBundle\\HotelRoomBundle',
                'HotelBillBundle' => 'Hotel\\BillBundle\\HotelBillBundle',
                'HotelMainBundle' => 'Hotel\\MainBundle\\HotelMainBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'SymfonyGZ',
            'database_user' => 'SymfonyGZ',
            'database_password' => 'symfonygz',
